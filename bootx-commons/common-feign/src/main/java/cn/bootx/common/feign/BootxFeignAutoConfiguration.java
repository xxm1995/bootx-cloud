...
import cn.bootx.common.feign.decoder.FeignResultDecoder;
...
import cn.bootx.common.feign.interceptor.DefaultInterceptor;
import cn.bootx.common.headerholder.HeaderHolder;
import cn.bootx.common.idempotency.IdempotencyProperties;
...
public class BootxFeignAutoConfiguration {
    ...
    public IdempotencyProviderInterceptor idempotencyOperationInterceptor() {
        return new IdempotencyProviderInterceptor(idemRedisClient, idempotencyProperties);
    }
