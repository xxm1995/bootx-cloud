package cn.bootx.common.feign.idempotency;
...
public class IdempotencyProviderInterceptor implements AsyncHandlerInterceptor {
    ...
    @Override
    public boolean preHandle(@NotNull HttpServletRequest request, @NotNull HttpServletResponse httpServletResponse, Object o) {
