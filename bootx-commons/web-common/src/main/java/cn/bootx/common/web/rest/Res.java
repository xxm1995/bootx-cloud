package cn.bootx.common.web.rest;

import static cn.bootx.common.web.code.CommonCode.FAIL_CODE;
import static cn.bootx.common.web.code.CommonCode.SUCCESS_CODE;
...
public class Res{
    ...
    public static <T> ResResult<T> ok(String message) {
