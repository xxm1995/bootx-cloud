...
public class CheckState {
     ...
     * 租户不存在
     */
    public static final CheckState TENANT_IS_EMPTY = new CheckState(420, "error.permission.tenantIsEmpty", "TENANT_IS_EMPTY");
    /**
     * 租户已停用
     */
    public static final CheckState TENANT_IS_DISABLED = new CheckState(421, "error.permission.tenantIsDisabled", "TENANT_IS_DISABLED");
