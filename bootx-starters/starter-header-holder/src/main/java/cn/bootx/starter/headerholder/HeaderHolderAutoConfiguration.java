...
import cn.bootx.starter.headerholder.holder.SingleHeaderHolder;
...
public class HeaderHolderAutoConfiguration {
    ...
    @Bean(name = "headerHolder")
    @ConditionalOnProperty(prefix = "bootx.starter.tenant",name = "single",havingValue="true",matchIfMissing = true)
    public HeaderHolder singleHeaderHolder(TenantProperties tenantProperties){
        return new SingleHeaderHolder(tenantProperties);
    }
