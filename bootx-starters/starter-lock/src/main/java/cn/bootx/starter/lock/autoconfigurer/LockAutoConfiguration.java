package cn.bootx.starter.lock.autoconfigurer;

import cn.bootx.starter.lock.LockAspectHandler;
import cn.bootx.starter.lock.LockInfoProvider;
import cn.bootx.starter.lock.config.LockConfigProperties;
import cn.bootx.starter.lock.config.LockConfigProperties.ClusterConfig;
import cn.bootx.starter.lock.config.LockConfigProperties.ReplicatedConfig;
import cn.bootx.starter.lock.config.LockConfigProperties.SentinelConfig;
import cn.bootx.starter.lock.config.LockConfigProperties.SingleConfig;
import cn.bootx.starter.lock.constant.LockConstant;
import cn.bootx.starter.lock.enums.ServerPattern;
import cn.bootx.starter.lock.factory.LockServiceFactory;
import cn.bootx.starter.lock.factory.ServerPatternFactory;
import cn.bootx.starter.lock.service.impl.*;
