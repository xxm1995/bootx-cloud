package cn.bootx.ordercenter.dto.order;
...
//    @ApiModelProperty("策略注册集合")
//    private List<StrategyRegisterDto> strategyRegisters;
//
//    @ApiModelProperty("策略注册id集合")
//    private List<Long> strategyRegisterIds;
