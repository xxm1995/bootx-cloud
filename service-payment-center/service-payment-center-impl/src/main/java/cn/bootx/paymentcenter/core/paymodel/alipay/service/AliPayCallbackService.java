...
public class AliPayCallbackService extends AbsPayCallbackStrategy {
    ...
    public AliPayCallbackService(RedisClient redisClient, PayNotifyRecordService payNotifyRecordService, PayCallbackService payCallbackService) {
    ...
    public boolean verifyNotify() {
        ...
        try {
            return AlipaySignature.rsaCheckV1(params, apiConfig.getAliPayPublicKey(), CharsetUtil.UTF_8, AlipayConstants.SIGN_TYPE_RSA2);
        }
