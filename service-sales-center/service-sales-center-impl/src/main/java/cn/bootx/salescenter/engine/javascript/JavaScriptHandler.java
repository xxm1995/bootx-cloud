package cn.bootx.salescenter.engine.javascript;

import cn.bootx.salescenter.core.strategy.entity.StrategyConfigValue;
import cn.bootx.salescenter.exception.strategy.StrategyCalculateException;
...
import static cn.bootx.common.util.BigDecimalUtil.CURRENCY_DECIMAL_PLACES;
    ...
    public static BigDecimal calculateByScript(BigDecimal originalValue, String script, List<StrategyConfigValue> configValues){
        try{
            ...
            return BigDecimal.valueOf(Double.parseDouble(eval.toString()))
                    .setScale(CURRENCY_DECIMAL_PLACES, BigDecimal.ROUND_HALF_UP);
